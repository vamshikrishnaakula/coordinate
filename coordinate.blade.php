...
<body style='background-color:corol'>
    {{-- newscript --}}
    ...
    <div class="container-fluid">
        <form id="myForm1" action="" type="post">
            ...
            <center >
                ...
                {{-- <img src="{{ url("images/$document->certificate_path") }}" alt="Your image" style="width: 1121px; height: 789px; "> --}}
            ...
            $('canvas').droppable({
                drop: function(event, ui) {
                    ...
                    // If the selected value doesn't exist in the array, add it
                        ...
                        inputs.push(dragvar + "," + roundedXPos + "," + roundedYPos);
                    }
